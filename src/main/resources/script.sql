...
INSERT INTO cinema.users(username,password,enabled) VALUES ('thomas@stud.kea.dk','thomas', true);
...
INSERT INTO cinema.user_roles (username, role) VALUES ('thomas@stud.kea.dk', 'ROLE_USER');